...
public class ProducStandardApi {
    ...
    @Autowired
    public ProducStandardApi(ProducStandardService producstandardService,StoreService storeService) {
    ...
    @ApiImplicitParam(paramType = "body", name = "producstandard", value = "要添加的商品规格", required = true, dataType = "ProductStandard")
    ...
    @ApiImplicitParam(paramType = "body", name = "producstandard", value = "要更新的商品规格", required = true, dataType = "ProductStandard")
    ...
    public ResponseEntity<?> queryProductStand(String productName, Long storeId, ApplicationTypeEnum applicationType) {
        ...
        //Store store = storeService.selectById(storeId,applicationType);
