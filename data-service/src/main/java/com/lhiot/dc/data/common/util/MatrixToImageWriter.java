package com.lhiot.dc.data.common.util;
...
//              image.setRGB(x, y,  (matrix.get(x, y) ? Color.YELLOW.getRGB() : Color.CYAN.getRGB()));
    ...
    public static void writeToFile(BitMatrix matrix, String format, OutputStream outputStream,String logoUri) throws IOException {
